...
from proteomescout_worker.geeneus.backend.Parser import BadXMLException

import string
import re

from proteomescout_worker.geeneus.backend import ProteinParser
from proteomescout_worker.geeneus.backend.Utilities import show_warning, show_error, show_status
